...
include(srcdir("formulations", "HopkinsTotal.jl"))
using .StaticHopkinsTotal
...
println("Starting StaticHopkinsTotal batch simulation")
...
for (i, sim_params) in enumerate(job_list)
    ...
    output_path = StaticHopkinsTotal.run_sim(global_params, sim_params)
