...
@inbounds function finalize_pressure!(p::Particle, ρ0::Float64, T_bg::Float64, γ::Float64, g::Float64, R_mass::Float64)
        p.P = p.P^γ
...
function run_sim(global_params::Dict, sim_params::Dict)
        ...
        function verlet_step!(sys)
                ...
                apply!(sys, p -> finalize_pressure!(p, ρ0, T_bg, γ, g, R_mass))
	...
	metadata_dict["module"] = "StaticPerturbedHopkins" # add module metadata manually
