...
"""
    update_ghost_density_perturbation!(p::Particle, ρ0::Float64, T_bg::Float64, g::Float64, R_mass::Float64)

Updates ρ′ for ghost particles after extrapolation so they are ready for the universal pressure call.
"""
