#!/bin/bash -l
#SBATCH --job-name=hopkins_pert
#SBATCH --output=hopkins_pert.%j.out
#SBATCH --error=hopkins_pert.%j.err
...
/usr/work/belank/julia-1.12.4/bin/julia -t $JULIA_NUM_THREADS hopkins_perturbed.jl
